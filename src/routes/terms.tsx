...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions | VixIQ X1" },
      {
        name: "description",
        content:
          "Read the Terms and Conditions for VixIQ X1 to understand the rules for using the service.",
      },
    ],
  }),
  component: Terms,
    ...
    >
      ...
      <section className="relative isolate overflow-hidden pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl mb-6">
          <Link
            to="/"
            className="inline-flex items-center rounded-full border border-white/10 bg-gradient-to-r from-sand via-umber to-cocoa px-4 py-2 text-sm text-white transition hover:opacity-90"
          >
            ← Back to homepage
          </Link>
        </div>
        <div className="mx-auto max-w-6xl rounded-[2rem] border border-white/10 bg-[#1F150C]/95 p-8 shadow-2xl shadow-black/40 sm:p-12">
          <div className="space-y-6">
            ...
            <div className="space-y-8 text-white/80" style={{ fontFamily: "var(--font-body)" }}>
              <section className="space-y-4">
                ...
                <ul className="ml-5 list-disc space-y-3">
                  ...
                  <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to MeroVix Technologies Inc, 350 Mission Street, Suite 600, San Francisco, CA 94105, USA.</li>
                  <li><strong>Device</strong> means any device that can access the Service such as a computer, a cell phone or a digital tablet.</li>
                  <li><strong>Service</strong> refers to the Website.</li>
                  <li><strong>Terms and Conditions</strong> (also referred to as "Terms") means these Terms and Conditions, including any documents expressly incorporated by reference, which govern Your access to and use of the Service and form the entire agreement between You and the Company regarding the Service. These Terms and Conditions have been created with the help of the <a className="text-[#E1DCC9] underline" href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank" rel="noreferrer">TermsFeed Terms and Conditions Generator</a>.</li>
              ...
              <section className="space-y-4">
                ...
                <ul className="ml-5 list-disc space-y-2">
                  <li>By email: <a className="text-[#E1DCC9] underline" href="mailto:contact@mero-vix.com">contact@mero-vix.com</a></li>
                </ul>
              </section>
            </div>
          </div>
