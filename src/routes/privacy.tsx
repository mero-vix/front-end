...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | VixIQ X1" },
      {
        name: "description",
        content:
          "Read the VixIQ X1 Privacy Policy to understand how we collect, use, and protect your information.",
      },
    ],
  }),
        ...
        <div className="mx-auto max-w-6xl rounded-[2rem] border border-white/10 bg-[#1F150C]/95 p-8 shadow-2xl shadow-black/40 sm:p-12">
          <div className="space-y-6">
            <div className="max-w-3xl space-y-3">
              ...
              <p className="text-base leading-8 text-white/80" style={{ fontFamily: "var(--font-body)" }}>
                We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a className="text-[#E1DCC9] underline" href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noreferrer">TermsFeed Privacy Policy Generator</a>.
              </p>
            </div>
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-4 text-white/80" style={{ fontFamily: "var(--font-body)" }}>
                  ...
                  <ul className="ml-5 list-disc space-y-3">
                    ...
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to MeroVix Technologies Inc, 350 Mission Street, Suite 600, San Francisco, CA 94105, USA.</li>
