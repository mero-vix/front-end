...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "VixIQ X1 is a generative AI marketing intelligence platform." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700;800&family=Lato:wght@300;400;700&family=Noto+Sans:wght@400;500;600&display=swap",
      },
    ],
  }),
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    if (!document.getElementById("tawk-script")) {
      ...
      s1.id = "tawk-script";
      s1.async = true;
      s1.src = "https://embed.tawk.to/6a2951f17898db1c31b44447/1jqomg6fc";
      s1.charset = "UTF-8";
