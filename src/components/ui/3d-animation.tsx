            ...
            <div className="container">
                ...
                >
                    <div className="container-full">
                        ...
                        <img className="backgroundImage" src={backgroundImageUrl} alt="An old stone courtyard at dawn" onError={(e) => (e.currentTarget.style.display = 'none')} />
                        <img className="boyImage" src={boyImageUrl} alt="A man and woman practicing with swords" onError={(e) => (e.currentTarget.style.display = 'none')} />
