...
export function ContactCard({
	...
	return (
		<div
			className={cn(
				'bg-card/40 backdrop-blur-md border border-white/10 relative grid h-full w-full shadow-lg rounded-xl md:grid-cols-2 lg:grid-cols-3 overflow-hidden',
				className,
			)}
			{...props}
		>
			...
			<div className="flex flex-col justify-between lg:col-span-2">
				<div className="relative h-full space-y-4 px-4 py-8 md:p-8">
					<h2 className="text-3xl font-bold md:text-4xl lg:text-5xl font-heading text-gradient">
						{title}
					</h2>
			...
			<div
				className={cn(
					'bg-white/[0.02] flex h-full w-full items-center border-t border-white/10 p-5 md:col-span-1 md:border-t-0 md:border-l',
					formSectionClassName,
				)}
			>
				{children}
...
function ContactInfo({
	...
	return (
		<div className={cn('flex items-center gap-3 py-3', className)} {...props}>
			<div className="bg-white/5 border border-white/10 rounded-lg p-3 text-sand">
